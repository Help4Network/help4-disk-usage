...
2. Let CI pass.
3. Tag the immutable release, for example `v0.3.6`, and push the tag.
...
cd help4-disk-usage-*
HELP4_DU_RELEASE_URL="https://github.com/Help4Network/help4-disk-usage/archive/refs/tags/v0.3.6.tar.gz" \
