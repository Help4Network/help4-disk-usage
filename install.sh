...
CONFIG_FILE="$CONFIG_FILE" RELEASE_URL="$RELEASE_URL" perl -MJSON::PP -0777 -e '
...
INSTALL_META="$INSTALL_META" VERSION="$VERSION" RELEASE_URL="$RELEASE_URL" BACKUP_DIR="$BACKUP_DIR" perl -MJSON::PP -e '
  my $meta = {
