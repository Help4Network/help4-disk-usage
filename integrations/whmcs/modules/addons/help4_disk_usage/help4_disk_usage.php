...
const H4DU_VERSION = '0.2.0';
const H4DU_DEFAULT_RELEASE_URL = 'https://github.com/Help4Network/help4-disk-usage/releases/latest/download/help4-disk-usage.tar.gz';
